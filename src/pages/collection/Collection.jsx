  ...
  return (
    <div className='text-white'>
      <div className='relative'>
        ...
        <img src={nft_5} className='b-4 absolute -bottom-4 left-20 border-4 w-20 sm:w-24 md:w-32 lg:w-40 border-white rounded-lg '/>
      </div>
      <div>
        <div className='mx-4 mb-0 mt-8 text-3xl font-bold'>Muses in my life</div>
        <div className='m-4 my-0 text-md font-semibold'>By RyanAnnet</div>
        <div className='mx-4 text-xs mb-2'>"Muses of My Life" is an exclusive NFT collection that features a series of digital artworks inspired by the muses that...</div>
        <div className='flex'>
          <div className='flex-col ml-4'><div>0.75ETH</div><div className='text-xs'>total volume</div></div>
          <div className='flex-col ml-4'><div>0.75ETH</div><div className='text-xs'>total volume</div></div>
          <div className='flex-col ml-4'><div>0.75ETH</div><div className='text-xs'>total volume</div></div>
          <div className='flex-col ml-4'><div>0.75ETH</div><div className='text-xs'>total volume</div></div>
          <div className='flex-col ml-4'><div>0.75ETH</div><div className='text-xs'>total volume</div></div>
