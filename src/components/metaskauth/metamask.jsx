    ...
    <div className=''>
      {isConnected ? (
        ...
        <button
          ...
          className='inline-flex items-center px-3 py-2 text-lg font-medium text-center hover:text-gray-200 text-black border-2 border-black bg-gradient-to-r  from-gray-600 to-green-200 '
        >
          Connect Wallet
        </button>
      )}
